Shader "MainMenu/PerkBackground"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Driven by C# using Time.unscaledTime — unaffected by timeScale = 0
            #define iTime (_UnscaledTime * _Speed)
